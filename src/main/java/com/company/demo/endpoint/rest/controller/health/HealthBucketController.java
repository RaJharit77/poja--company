package com.company.demo.endpoint.rest.controller.health;

import static com.company.demo.file.hash.FileHashAlgorithm.NONE;
...
import com.company.demo.file.hash.FileHash;
import java.io.File;
